        ...
        <div class="title-wrapper pt-30">
          <div class="row align-items-center">
            <div class="col-md-6">
              ...
              <h3>for each di database</h3>
    <ul>
        <li>buat database bernama <b>db_rpl2324</b></li>
        <li>buat tabel bernama <b>tbl_foreach</b> di database yang kita buat</li>
        <li>isi table dangan data</li>
        <li>kita harus buat skrip untuk menghubungkan php dan database,buat file dengan nama <b>konesi.php</b></li>
        <li>tampilkan data di database dengan file bernama <b>data_siswa.php</b></li>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>menampilkan data siswa dengan foreach</title>
</head>
...
<table class="table table-hover table-bordered table-centered mb-0">
    ...
    <tbody>
            ...
            <td>Jl. Babakan Sari II No. ada deh</td>
        </tr>
            <tr>
            <td>2</td>
            <td>Hasna Jauza Salsabila</td>
            <td>XI RPL</td>
            <td>Teknik Sepeda Motor</td>
            <td>Jl. Babakan Sumedang No. ???</td>
        </tr>
            <tr>
            <td>3</td>
            <td>Mas Ganteng</td>
            ...
            <td>XI RPL</td>
            <td>Perhotelan</td>
            <td>Alamat Ibrahim</td>
        </tr>
            <tr>
            <td>5</td>
            <td>Mulqi Fathurahman</td>
            <td>XI RPL</td>
            <td>Farmasi dan Klinik</td>
            <td>Jl. Antapani lama Gg. Angrek No.??</td>
        </tr>
            <tr>
            <td>6</td>
            <td>Adi Sasongko</td>
            <td>XI</td>
            <td>Akutansi</td>
            <td>Padasuka teuing di belah mana na</td>
        </tr>
            <tr>
            <td>7</td>
            <td>Dzaki</td>
