      ...
      <ul>
        <li class="nav-item nav-item-has-children">
          ...
          <ul id="ddmenu_3" class="collapse show dropdown-nav">
            ...
            <li>
              <a href="foreach.php" class="active">
                <span class="text">
                  For each
              </a>
            </li>
          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              ...
              <div style="background: #eeeedd; overflow:auto;width:auto;border:solid gray;border-width:.1em .1em .1em .8em;padding:.2em .6em;"><table><tr><td><pre style="margin: 0; line-height: 125%">1
                ...
                <span style="color: #00688B">$makananEnak</span> = [<span style="color: #CD5555">&quot;mie&quot;</span>, <span style="color: #CD5555">&quot;es krim&quot;</span>, <span style="color: #CD5555">&quot;piza&quot;</span>];
                <span style="color: #8B008B; font-weight: bold">foreach</span> (<span style="color: #00688B">$makananEnak</span> <span style="color: #8B008B; font-weight: bold">as</span> <span style="color: #00688B">$a</span>) {
                    <span style="color: #8B008B; font-weight: bold">echo</span> <span style="color: #CD5555">&quot;Saya Suka {</span><span style="color: #00688B">$a</span><span style="color: #CD5555">}&lt;br&gt;&quot;</span>;
                }
                <span style="color: #1e889b">?&gt;</span>
                </pre></td></tr></table></div>
                
                Saya Suka mie<br>Saya Suka es krim<br>Saya Suka piza<br>
                                </div> <!-- container -->
                            </div> <!-- content -->
            </div>
            <!-- end col -->
