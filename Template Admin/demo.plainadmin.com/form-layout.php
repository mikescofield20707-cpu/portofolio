...
<!-- Mirrored from form-layout by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 May 2024 01:26:51 GMT -->
      ...
      <form action="#">
        <div class="row">
          ...
          <div class="col-12">
            <div class="input-style-1">
              <label>Address</label>
              <input type="text" placeholder="JL.XXXXX-XXXXX">
            </div>
          </div>
          <!-- end col -->
