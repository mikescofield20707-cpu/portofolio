      ...
      <ul>
        <li class="nav-item nav-item-has-children">
          ...
          <ul id="ddmenu_4" class="collapse show dropdown-nav">
            ...
            <li>
              <a href="array2.php" class="active">
                <span class="text">
                  Array 2
              </a>
            </li>
        ...
        <div class="title-wrapper pt-30">
          <div class="row align-items-center">
            <div class="col-md-6">
              ...
              <div class="kotak">157</div>
              <div class="kotak">482</div>
              <div class="kotak">76</div>
              <div class="kotak">934</div>
              <div class="kotak">201</div>
              <div class="kotak">518</div>
              <div class="kotak">333</div>
              <div class="kotak">749</div>
