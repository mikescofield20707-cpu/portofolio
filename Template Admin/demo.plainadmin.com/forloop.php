      ...
      <ul>
        <li class="nav-item nav-item-has-children">
          ...
          <ul id="ddmenu_3" class="collapse show dropdown-nav">
            <li>
              <a href="forloop.php" class="active"> 
                <span class="text">
                  For
              </a>
            </li>
        ...
        <div class="title-wrapper pt-30">
          <div class="row align-items-center">
            ...
            5</pre>
                        ...
                        <td>
                            <pre style="margin: 0; line-height: 125%"><span style="color: #1e889b">&lt;?php</span>
            <span style="color: #8B008B; font-weight: bold">for</span> (<span style="color: #00688B">$i</span> = <span style="color: #B452CD">1</span>; <span style="color: #00688B">$i</span> &lt;= <span style="color: #B452CD">100</span>; <span style="color: #00688B">$i</span>++) {
                    <span style="color: #8B008B; font-weight: bold">echo</span> <span style="color: #CD5555">&quot;Loop ke-&quot;</span> . <span style="color: #00688B">$i</span>  . <span style="color: #CD5555">&quot; &lt;br&gt;&quot;</span>;
                }
