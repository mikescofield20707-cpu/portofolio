      ...
      <ul>
        <li class="nav-item nav-item-has-children">
          ...
          <ul id="ddmenu_3" class="collapse show dropdown-nav">
            ...
            <li>
              <a href="dowhile.php" class="active">
                <span class="text">
                  Do while
              </a>
            </li>
            ...
            <div class="col-md-6">
              ...
              <div style="background: #eeeedd; overflow:auto;width:auto;border:solid gray;border-width:.1em .1em .1em .8em;padding:.2em .6em;"><table><tr><td><pre style="margin: 0; line-height: 125%">1
                ...
                <span style="color: #8B008B; font-weight: bold">do</span> {
                    <span style="color: #8B008B; font-weight: bold">echo</span> <span style="color: #CD5555">&quot;looping ke-&quot;</span> . <span style="color: #00688B">$i</span>  . <span style="color: #CD5555">&quot;&lt;br&gt;&quot;</span>;
                ...
                looping ke-1<br>looping ke-2<br>looping ke-3<br>looping ke-4<br>looping ke-5<br>looping ke-6<br>looping ke-7<br>looping ke-8<br>looping ke-9<br>looping ke-10<br>
                                </div> <!-- container -->
                            </div> <!-- content -->
            </div>
            <!-- end col -->
