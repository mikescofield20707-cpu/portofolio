          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              ...
              <div style="background: #eeeedd; overflow:auto;width:auto;border:solid gray;border-width:.1em .1em .1em .8em;padding:.2em .6em;"><table><tr><td><pre style="margin: 0; line-height: 125%">1
                ...
                4
                5
                6</pre></td><td><pre style="margin: 0; line-height: 125%"><span style="color: #1e889b">&lt;?php</span>
                <span style="color: #00688B">$i</span> = <span style="color: #B452CD">1</span>;
                <span style="color: #8B008B; font-weight: bold">while</span> (<span style="color: #00688B">$i</span> &lt;= <span style="color: #B452CD">10</span>) {
                    <span style="color: #8B008B; font-weight: bold">echo</span> <span style="color: #CD5555">&quot;ini putaran ke-&quot;</span> . <span style="color: #00688B">$i</span>  . <span style="color: #CD5555">&quot;&lt;br&gt;&quot;</span>;
                    <span style="color: #00688B">$i</span>++;
                <span style="color: #1e889b">?&gt;</span>
                </pre></td></tr></table></div>
                
                ini putaran ke-1<br>ini putaran ke-2<br>ini putaran ke-3<br>ini putaran ke-4<br>ini putaran ke-5<br>ini putaran ke-6<br>ini putaran ke-7<br>ini putaran ke-8<br>ini putaran ke-9<br>ini putaran ke-10<br>
                                </div> <!-- container -->
                            </div> <!-- content -->
