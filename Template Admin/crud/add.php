...
<div class="item form-group">
  <label class="col-form-label col-md-3 col-sm-3 " for="first-name">Nama Lengkap <span class="required"></span>
  </label>
...
<div class="item form-group">
  <label class="col-form-label col-md-3 col-sm-3 " for="last-name">Kelas <span class="required"></span>
  </label>
  <div class="input-group">
    <input type="text" id="last-name" required="required" class="form-control" name="Kelas">
  </div>
...
<div class="item form-group">
  ...
  <div class="input-group">
    <select class="custom-select rounded-0" id="exampleSelectJurusan" name="Jurusan">
      ...
      <option value="Farmasi dan Klinik">Farmasi dan Klinik</option>
      <option value="Perhotelan">Perhotelan</option>
      <option value="Jasa Boga">Jasa Boga</option>
      <option value="Akutansi">Akutansi</option>
      <option value="Menegemen Perkantoran">Menegemen Perkantoran</option>
                            </select>
                        </div>
</div>
