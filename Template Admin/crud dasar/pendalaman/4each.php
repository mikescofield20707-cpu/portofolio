...
<!-- Mirrored from demo.plainadmin.com/blank-page by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 May 2024 01:26:03 GMT -->
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Pendalaman</a></li>
                            <li class="breadcrumb-item active">for each </li>
                        </ol>
                    </div>
                    <h4 class="page-title">for each </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
    
        <h3>penulisan foreach tanpan key</h3>Saya Suka mie<br>Saya Suka es krim<br>Saya Suka piza<br><hr><h3>penulisan foreach dengan index key</h3>1.mie<br>2.es krim<br>3.piza<br><hr><h3>penulisan foreach dengan associative </h3>Mie : indomie<br>Es krim : walls<br>Piza : domino<br><hr><h3>penulisan foreach dengan pemilihan </h3><select name="makan"><option value="1">mie</option>
    <option value="2">es krim</option>
    <option value="3">piza</option>
    </select><hr><h3>penulisan foreach dengan table</h3><table border="1" cellpadding="3" cellspacing="0"><tr style='background-color: yellow'><td>no</td><td>Jenis</td><td>Merek</td></tr><tr><td>1</td><td>Mie</td><td>indomie</td></tr><tr><td>2</td><td>Es krim</td><td>walls</td></tr><tr><td>3</td><td>Piza</td><td>domino</td></tr></table>
    </div> <!-- container -->
                    </div> <!-- container -->
                </div> <!-- content -->
            </div>
